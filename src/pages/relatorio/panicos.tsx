        ...
        >
          ...
          >
            ...
            >
              ...
              <MultiSelect
                ...
                options={(() => {
                  const funcionariosSelect: Record<string, string> = {};
                  Object.keys(funcionarios.current).forEach((key) => {
                    funcionariosSelect[funcionarios.current[key].id] =
                      funcionarios.current[key].nome;
                  });
                  return funcionariosSelect;
                })()}
              />
            </div>
          </div>
          <Table
            ...
            columns={[
              ...
              { name: "Login", size: 1 },
              { name: "Área", size: 1 },
              { name: "Data (Acionamento)", size: 1.2 },
              { name: "Horário (Acionamento)", size: 1.2 },
              { name: "Data (leitura)", size: 1 },
              { name: "Horário (leitura)", size: 1 },
            ]}
          />
        </div>
      </Paper>
